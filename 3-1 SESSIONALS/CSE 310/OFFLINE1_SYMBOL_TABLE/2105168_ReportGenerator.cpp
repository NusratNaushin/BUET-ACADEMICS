...
int main()
{
    ...
    string output_filename = "2105168_input_output_txt/reportgenerator.txt";
    ...
    while (hashchoice < 4)
    {
      ...
      //  cout << "\n====== Hash Function " << hashchoice << " ======\n";
        ...
        FILE *outFile;
        if (hashchoice == 1)
            outFile = freopen(output_filename.c_str(), "w", stdout);
        else
            outFile = freopen(output_filename.c_str(), "a", stdout);
        ...
        st->setHashFucntion(hashchoice);

        cout << hashchoice << endl;

        cout << "Collision Count : " << st->getCollsionCount() << endl;
