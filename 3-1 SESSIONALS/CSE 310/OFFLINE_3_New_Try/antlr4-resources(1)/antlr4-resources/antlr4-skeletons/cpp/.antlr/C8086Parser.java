	...
	public final Func_definitionContext func_definition() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				//         if(_localctx.type != ((Func_definitionContext)_localctx).cs.type)
				//         {
				// std::cout << "[" << ((Func_definitionContext)_localctx).cs.type << "]" << std::endl;
