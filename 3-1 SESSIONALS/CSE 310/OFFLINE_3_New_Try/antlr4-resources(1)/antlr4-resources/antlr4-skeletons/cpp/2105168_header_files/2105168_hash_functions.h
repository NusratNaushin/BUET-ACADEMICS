...
static unsigned int aux_hash(std::string str  , unsigned int num_buckets){
...
static unsigned int polynomial_rolling_hash(std::string str , unsigned int num_buckets){
