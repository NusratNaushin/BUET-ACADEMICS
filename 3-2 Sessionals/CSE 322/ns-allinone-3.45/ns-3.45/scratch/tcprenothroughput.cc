/*
 * TCP Reno - throughput output to file
...
NS_LOG_COMPONENT_DEFINE("TcpRenoThroughput");
...
main(int argc, char* argv[])
{
    ...
    g_throughputFile.open("throughput-Reno.tr");
    ...
    // Default TCP = NewReno, no change needed
    ...
    if (tracing)
    {
        ...
        bottleneck.EnableAsciiAll(ascii.CreateFileStream("reno.tr"));
    }
